...
from geneus.draft.env import N_DRAFT_TOKENS, N_CHAR_STATES, BAN_PHASE, PICK_1
...
def test_output_shape(q_net):
    ...
    turn = jnp.array(BAN_PHASE, dtype=jnp.int32)
...
def test_different_turn_tokens_differ(q_net):
    ...
    out_ban = q_net(char_encs, states, jnp.array(BAN_PHASE, dtype=jnp.int32))
